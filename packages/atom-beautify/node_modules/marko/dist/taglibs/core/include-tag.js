...
function doInclude(input, out, throwError) {
    ...
    if (renderBody) {
        ...
        var componentDef = componentsContext && componentsContext._q_;
        var willRerenderInBrowser = componentDef && componentDef._f_ & FLAG_WILL_RERENDER_IN_BROWSER;
        var key = (componentDef && componentDef.id) + " " + out.ab_;
