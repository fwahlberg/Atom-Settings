...
function requestData(provider, args, thisObj, timeout) {
    ...
    if (typeof provider === "function") {
        ...
        if (value !== undefined) {
            asyncValue.bD_(value);
        }
    } else {
        // Assume the provider is a data object...
        asyncValue.bD_(provider);
    }
    ...
    if (timeout > 0) {
        let timeoutId = setTimeout(function () {
            ...
            asyncValue.bC_(error);
        }, timeout);

        asyncValue.bB_(function () {
            if (timeoutId != null) {
...
module.exports = function awaitTag(input, out) {
    ...
    if (clientReorder) {
        ...
        clientReorderContext = out.global.bE_ || (out.global.bE_ = {
            instances: [],
            nextId: 0
        });
