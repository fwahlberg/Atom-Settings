...
function VElement(tagName, attrs, key, component, childCount, flags, props) {
    ...
    this.ax_ = key;
    this._b_ = component;
    this.bo_ = attrs || EMPTY_OBJECT;
    this.ak_ = props || EMPTY_OBJECT;
    this.bp_ = namespaceURI;
    this.aq_ = tagName;
    this.bq_ = null;
    this.az_ = constId;
    this.br_ = isTextArea;
...
VElement.prototype = {
    ...
    e: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.bb_(new VElement(tagName, attrs, key, component, childCount, flags, props));
    ...
    ed: function (tagName, attrs, key, component, childCount, flags, props) {
        var child = this.bb_(VElement.bc_(tagName, attrs, key, component, childCount, flags, props));
    ...
    ar_: function (doc) {
        var namespaceURI = this.bp_;
        var tagName = this.aq_;

        var attributes = this.bo_;
        var flags = this._f_;
...
defineProperty(proto, "aA_", {
    get: function () {
        var value = this.bq_;
        if (value == null) {
            value = this.bo_.value;
        }
        return value != null ? toString(value) : "";
    }
});

VElement.bc_ = function (tagName, attrs, key, component, childCount, flags, props) {
...
function virtualizeElement(node, virtualizeChildNodes) {
    ...
    if (node.namespaceURI !== "http://www.w3.org/1999/xhtml") {
        vdomEl.bp_ = node.namespaceURI;
    }

    if (vdomEl.br_) {
        vdomEl.bq_ = node.value;
    } else {
...
VElement.ao_ = virtualizeElement;

VElement.ap_ = function (fromEl, vFromEl, toEl) {
