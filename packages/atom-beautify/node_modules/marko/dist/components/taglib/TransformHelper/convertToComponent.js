...
module.exports = function handleComponentBind(options) {
    ...
    if (rendererModule && rendererModule !== componentModule || !rendererModule && componentModule) {
        componentProps._Z_ = isSplit = true;
    }
    ...
    if (componentModule) {
        ...
        componentProps._m_ = componentTypeNode;
    ...
    if (flags) {
        context.root.appendChild(builder.assignment(builder.memberExpression(builder.identifier("__component"), builder.identifier("_f_")), builder.literal(flags), "|="));
    }
