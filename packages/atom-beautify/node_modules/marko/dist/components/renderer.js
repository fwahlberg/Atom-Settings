...
function resolveComponentKey(globalComponentsContext, key, ownerComponentDef, parentComponentDef) {
    if (key[0] === "#") {
        ...
        return parentComponentDef._i_(ownerComponentDef.id + "-" + key);
    }
}
...
function handleBeginAsync(event) {
    ...
    asyncOut.c(parentOut.a__, parentOut.ab_, parentOut.aa_);
}
...
function createRendererFunc(templateRenderFunc, componentProps, renderingLogic) {
    ...
    var isSplit = componentProps._Z_ === true;
    var isImplicitComponent = componentProps.af_ === true;
    ...
    return function renderer(input, out) {
        ...
        if (isServer) {
            ...
            component = registry._o_(renderingLogic, id, input, out, typeName, customEvents, scope);
...
createRendererFunc._X_ = resolveComponentKey;
createRendererFunc._Y_ = handleBeginAsync;